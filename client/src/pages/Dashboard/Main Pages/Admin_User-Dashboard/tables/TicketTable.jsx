...
const TicketTable = ({ tableData, setMessageData, setShowModal, setClickedButton}) => {
    ...
    <>
      <div className="bg-white p-4 mt-4 rounded-lg">
        ...
        <p className="mb-4 text-gray-700">
          View your User Support Ticket history here. For any issues, use our
                ...
                <tbody>
                  {currentRows.map((row, index) => (
                    <tr key={index}>
                      ...
                      <td className="border-t border-b border-gray-200 p-2 text-center">
                        <FaEye
                          className="text-gray-400 text-lg mr-2 cursor-pointer hover:text-gray-600 transition duration-300 ease-in-out"
                          onClick={() => {
                            setMessageData(row?.conversation);
                            setShowModal(true);
                            setClickedButton("view-message");
                          }}
                        />
                      </td>
                    </tr>
